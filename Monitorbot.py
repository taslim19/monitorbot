...
BOTS_TO_MONITOR = {
    "Bot1": {"token": "BOT1_TOKEN"},
    "Bot2": {"token": "BOT2_TOKEN"},
    "Bot3": {"token": "BOT3_TOKEN"},
}
...
if __name__ == "__main__":
    ...
    if loop and loop.is_running():
        ...
        loop.create_task(main())  # Run as a background task
    else:
        print("Starting a new event loop.")
        asyncio.run(main())  # Start a new event loop only if none is running
